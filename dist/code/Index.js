...
const Rd_HexComplainment = (cuttedString) => {
    ...
    for (let y = cuttedString.length - 1; y >= 0; y--) {
        switch (cuttedString[yOpost]) {
            case '0':
                AKPNumber = AKPNumber + (0 * 16 ** y);
                break;
            case '1':
                AKPNumber = AKPNumber + (1 * 16 ** y);
                break;
            case '2':
                AKPNumber = AKPNumber + (2 * 16 ** y);
                break;
            case '3':
                AKPNumber = AKPNumber + (3 * 16 ** y);
                break;
            case '4':
                AKPNumber = AKPNumber + (4 * 16 ** y);
                break;
            case '5':
                AKPNumber = AKPNumber + (5 * 16 ** y);
                break;
            case '6':
                AKPNumber = AKPNumber + (6 * 16 ** y);
                break;
            case '7':
                AKPNumber = AKPNumber + (7 * 16 ** y);
                break;
            case '8':
                AKPNumber = AKPNumber + (8 * 16 ** y);
                break;
            case '9':
                AKPNumber = AKPNumber + (9 * 16 ** y);
                break;
            case 'a':
                AKPNumber = AKPNumber + (10 * 16 ** y);
                break;
            case 'b':
                AKPNumber = AKPNumber + (11 * 16 ** y);
                break;
            case 'c':
                AKPNumber = AKPNumber + (12 * 16 ** y);
                break;
            case 'd':
                AKPNumber = AKPNumber + (13 * 16 ** y);
                break;
            case 'e':
                AKPNumber = AKPNumber + (14 * 16 ** y);
                break;
            case 'f':
                AKPNumber = AKPNumber + (15 * 16 ** y);
                break;
        }
        yOpost = yOpost + 1;
    }
...
const controlLeft = () => {
    let newTextGetta = document.getElementById("TextInputLeft");
    let textGetta = new String(newTextGetta.value);
    //console.log(textGetta)
    const keyGive = document.getElementById("SelectLeft");
    const keyWanna = document.getElementById("SelectRight");
    //console.log("Key give ==" + String(keyGive) + '; Key Wanna =' + String(keyWanna))
    let codeKeyLeft;
    if (keyGive.value == 'Tzar' || keyGive.value == 'Vin') {
        codeKeyLeft = document.getElementById("KeySpaceLeft");
    }
    let transformKey;
    switch (keyGive.value) {
        case "UTF-8":
            transformKey = Rd_PtBr(textGetta);
            break;
        case "Bin":
            transformKey = Rd_Bin(textGetta);
            break;
        case "Hex":
            transformKey = Rd_Hex(textGetta);
            break;
        case "Tzar":
            transformKey = Rd_Tzar(textGetta, codeKeyLeft.value);
            break;
        case "Vin":
            transformKey = Rd_Vin(textGetta, codeKeyLeft.value);
            break;
    }
    console.log(textGetta);
    ...
    switch (keyWanna.value) {
        case "UTF-8":
            keyAbstract = R_PtBr(transformKey);
            break;
        case "Bin":
            keyAbstract = R_Bin(transformKey);
            break;
        case "Hex":
            keyAbstract = R_Hex(transformKey);
            break;
        case "Tzar":
            keyAbstract = R_Tzar(transformKey, 'R');
            break;
        case "Vin":
            keyAbstract = R_Vin(transformKey, 'R');
            break;
    }
...
const controlRight = () => {
    let newTextGetta = document.getElementById("TextInputRight");
    let textGetta = new String(newTextGetta.value);
    //console.log(textGetta)
    const keyGive = document.getElementById("SelectRight");
    const keyWanna = document.getElementById("SelectLeft");
    //console.log("Key give ==" + String(keyGive) + '; Key Wanna =' + String(keyWanna))
    let codeKeyRight;
    if (keyGive.value == 'Tzar' || keyGive.value == 'Vin') {
        codeKeyRight = document.getElementById("KeySpaceRight");
    }
    let transformKey;
    switch (keyGive.value) {
        case "UTF-8":
        ...
        case "Hex":
            ...
            break;
        case "Tzar":
            transformKey = Rd_Tzar(textGetta, codeKeyRight.value);
            break;
        case "Vin":
            transformKey = Rd_Vin(textGetta, codeKeyRight.value);
            break;
    }
    console.log(textGetta);
    console.log(transformKey);
    ...
    switch (keyWanna.value) {
        ...
        case "Hex":
            ...
            break;
        case "Tzar":
            keyAbstract = R_Tzar(transformKey, 'L');
            break;
        case "Vin":
            keyAbstract = R_Vin(transformKey, 'L');
            break;
    }
    console.log(keyAbstract);
    return keyAbstract;
...
const KeyLeftSense = document.getElementById("SelectLeft").addEventListener("change", function KeyLeftSense(e) {
    ...
    const KeyElement = document.getElementById("SelectLeft");
...
const KeyRightSense = document.getElementById("SelectRight").addEventListener("change", function KeyRightSense(e) {
    //console.log(e.target.value)
    const KeyElement = document.getElementById("SelectRight");
...
const AntiVinTzarBugLeft = document.getElementById("SelectLeft");
const NewAntiVinTsarBugLeft = AntiVinTzarBugLeft.value;
const AntiVinTzarBugRight = document.getElementById("SelectRight");
